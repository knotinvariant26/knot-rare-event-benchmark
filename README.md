...
If the preprocessing script supports custom file paths, those paths may be passed directly instead.
...
This reproduces the bulk accessibility results reported in Table 1 of the paper. The probe is a class-balanced multinomial logistic regression trained on:
...
They are included as contextual comparisons only. They are not used as the main basis for the reconstruction-based claims.
